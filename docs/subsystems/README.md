...
| [embedding.md](embedding.md) | provider-neutral document/query vectors, vector-space identity, selection, and the local deterministic development provider |
| [knowledge.md](knowledge.md) | tenant-and-subject-scoped knowledge bases, bounded ingestion, hybrid retrieval, stable citations, and model-facing search |
