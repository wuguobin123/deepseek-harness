...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  accountPlatform: 'llm-streaming.md',
  accountPluginFactory: 'skills.md',
  accountSkillStore: 'skills.md',
  artifactRegistry: 'attachment.md',
  connection: 'client-modules.md',
  emailVerification: 'credentials.md',
  identity: 'credentials.md',
  userModelKeys: 'credentials.md',
  wallet: 'credentials.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  userContext: 'host-side context declaration without a rendered service provider — packages/memory/user-context/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ResolvedPiAiProviderProfile: '../../packages/llm/llm-pi-ai/README.md',
  ...
  EmbeddingIdentity: 'embedding.md',
  EmbeddingProvider: 'embedding.md',
  EmbeddingResult: 'embedding.md',
  KnowledgeBase: 'knowledge.md',
  KnowledgeBaseId: 'knowledge.md',
  KnowledgeBaseInput: 'knowledge.md',
  KnowledgeDocumentId: 'knowledge.md',
  KnowledgeDocumentInput: 'knowledge.md',
  KnowledgeIngestJob: 'knowledge.md',
  KnowledgeIngestJobId: 'knowledge.md',
  KnowledgeProvider: 'knowledge.md',
  KnowledgeScope: 'knowledge.md',
  KnowledgeSearchRequest: 'knowledge.md',
  KnowledgeSearchResult: 'knowledge.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  // ---- xiaowei multi-user account types (PR 2 step 10.1b) ----
  ...
  InvitationId: 'invitation identity brand is owned by packages/account/identity/src/types.ts',
  InvitationView: 'invitation metadata view is owned by packages/account/identity/src/types.ts',
  ...
  ActiveModelCredential: 'account model credential contract is owned by packages/account/model-keys/README.md',
  CustomModelView: 'account custom-model view is owned by packages/account/model-keys/README.md',
  CustomModelId: 'account custom-model identity is owned by packages/account/model-keys/README.md',
  ResolvedCustomModel: 'resolved custom-model contract is owned by packages/account/model-keys/README.md',
  AccountPluginView: 'account plugin view is owned by packages/account/plugin-factory/README.md',
  PluginCatalogEntry: 'account plugin catalog entry is owned by packages/account/plugin-factory/README.md',
  PluginActivator: 'account plugin activator is owned by packages/account/plugin-factory/README.md',
  SessionOwnerId: 'account skill owner identity is owned by packages/account/skill-store/README.md',
  SkillInstallInput: 'account skill install input is owned by packages/account/skill-store/README.md',
  SkillInstallResult: 'account skill install result is owned by packages/account/skill-store/README.md',
  WalletReservation: 'wallet reservation contract is owned by packages/account/wallet/README.md',
  WalletSettlement: 'wallet settlement contract is owned by packages/account/wallet/README.md',
  WriteArtifactInput: 'artifact write input is owned by packages/artifact/artifact/README.md',
  ArtifactView: 'artifact view is owned by packages/artifact/artifact/README.md',
  StoredArtifact: 'stored artifact contract is owned by packages/artifact/artifact/README.md',
  DocumentAttachmentRef: 'document attachment reference is owned by packages/attachment/attachment/README.md',
  SaveDocumentAttachment: 'document attachment write input is owned by packages/attachment/attachment/README.md',
  StoredDocumentAttachment: 'stored document attachment is owned by packages/attachment/attachment/README.md',
  RpcPrincipal: 'API proxy principal is owned by packages/host/apiproxy/README.md',
}
