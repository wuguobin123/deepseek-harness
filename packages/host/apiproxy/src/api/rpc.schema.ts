...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('email-code-resend-cooldown'), message: z.string(), details: z.object({ retryAfterSeconds: z.number() }) }),
  z.object({ code: z.literal('email-code-rate-limit'), message: z.string(), details: z.object({ retryAfterSeconds: z.number() }) }),
  z.object({ code: z.literal('email-code-wrong'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('email-code-expired'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('email-code-locked'), message: z.string(), details: z.object({ retryAfterSeconds: z.number() }) }),
  z.object({ code: z.literal('verification-code-required'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('email-taken'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('invitation-invalid'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('invitation-limit'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('user-limit'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('insufficient-balance'), message: z.string(), details: z.object({ userId: z.string(), balanceMicros: z.number(), attemptedMicros: z.number() }) }),
  z.object({ code: z.literal('model-key-not-found'), message: z.string(), details: z.object({ keyId: z.string() }) }),
  z.object({ code: z.literal('artifact-not-found'), message: z.string(), details: z.object({ artifactId: z.string() }) }),
  z.object({ code: z.literal('artifact-corrupt'), message: z.string(), details: z.object({ artifactId: z.string(), reason: z.string() }) }),
