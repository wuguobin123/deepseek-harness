...
export const zh = {
  ...
  'group.local': '本机工作区',
  'group.cloud': '云端工作区',
  'group.local.expand': '展开本机工作区',
  'group.local.collapse': '收起本机工作区',
  'group.cloud.expand': '展开云端工作区',
  'group.cloud.collapse': '收起云端工作区',
  'group.local.add': '添加本机工作区',
  'group.cloud.add': '添加云端工作区',
  'session.new': '新会话',
  ...
  'menu.openLocalWorkspace': '打开本机文件夹（实时使用）',
  'menu.importCloudCopy': '导入云端副本（独立副本）',
  'menu.useComputerFolder': '使用电脑上的文件夹',
  'menu.advancedOptions': '高级选项',
...
export const en = {
  ...
  'group.local.expand': 'Expand local workspaces',
  'group.local.collapse': 'Collapse local workspaces',
  'group.cloud.expand': 'Expand cloud workspaces',
  'group.cloud.collapse': 'Collapse cloud workspaces',
  'group.local.add': 'Add local workspace',
  'group.cloud.add': 'Add cloud workspace',
  ...
  'menu.openLocalWorkspace': 'Open local folder (live files)',
  'menu.importCloudCopy': 'Import cloud copy (independent copy)',
  'menu.useComputerFolder': 'Use a folder on this computer',
  'menu.advancedOptions': 'Advanced options',
