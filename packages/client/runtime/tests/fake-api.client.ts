...
export class FakeApiClient implements IApiClient {
  ...
  onWorkspaceImportDirectory: (payload: unknown) => Promise<RpcResponse<{ workspace: WorkspaceView; created: boolean }>> =
    () => Promise.resolve(ok({ workspace: fakeWorkspace('fk-import'), created: true }))
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    importDirectory: (payload: unknown) =>
      this.record('workspace.importDirectory', payload, this.onWorkspaceImportDirectory(payload)),
