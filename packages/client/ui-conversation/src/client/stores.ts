...
type ChatActions = {
  ...
  setArtifact: (draft: ChatStoreState, artifactId: string | null) => void
}
...
export function createChatStore(): EngineStoreHandle<ChatStoreState, ChatActions> {
  return defineStore({
    ...
    init: (): ChatStoreState => ({ selection: null, draft: '', view: null, inspect: null, artifactId: null }),
    ...
    actions: {
      ...
      setArtifact: (d, artifactId: string | null) => { d.artifactId = artifactId },
    },
  })
}
