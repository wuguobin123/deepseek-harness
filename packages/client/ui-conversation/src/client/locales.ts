...
export const zh = {
  ...
  'message.maxTokens.hint': '回答被截断，已有输出保留在对话中。你可以手动发送消息继续。',
  'message.maxTokens.continued': '已自动续写 {ordinal}/{limit}',
  'message.maxTokens.autoHint': '模型将自动接着输出。',
...
export const en = {
  ...
  'file.add': 'Add file',
  'file.addHint': 'Upload PDF, Word, Excel, PowerPoint, or an image',
  'file.close': 'Close file details',
  ...
  'chat.retryHistory': 'Retry loading',
  ...
  'message.maxTokens.hint': 'The reply was cut off; earlier output is preserved. You can continue manually.',
  'message.maxTokens.continued': 'Automatically continued {ordinal}/{limit}',
  'message.maxTokens.autoHint': 'The model will continue automatically.',
