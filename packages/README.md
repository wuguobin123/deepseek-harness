...
|---|---|---|
| [`core/`](core/README.md) | Sessions, prompts, tools, agents, loop | Product — stable API |
...
| [`subprocess/`](subprocess/README.md) | Subprocess seam and local provider | Product — stable API |
| [`shell/`](shell/README.md) | Shell seam, providers, tools | Product — stable API |
| [`terminal/`](terminal/README.md) | Persistent PTY sessions and tools | Product — stable API |
| [`code-runtime/`](code-runtime/README.md) | Code Mode service and providers | Product — stable API |
| [`sandbox/`](sandbox/README.md) | Process-confinement seam; bwrap/Landlock/Seatbelt backends | Product — stable API |
| [`fs/`](fs/README.md) | Filesystem seam, providers, tools | Product — stable API |
| [`lsp/`](lsp/README.md) | LSP seam, stdio provider, tool | Product — stable API |
| [`skill/`](skill/README.md) | Skill registry, providers, loader | Product — stable API |
| [`compaction/`](compaction/README.md) | Compaction service, provider, command | Product — stable API |
...
| [`subagent/`](subagent/README.md) | Subagent registry, providers, delegation tool | Product — stable API |
...
| [`web/`](web/README.md) | Web seam, providers, tools | Product — stable API |
| [`knowledge/`](knowledge/README.md) | Tenant knowledge and cited search | Product — evolving API |
...
| [`document/`](document/README.md) | Bounded document readers | Product — evolving API |
