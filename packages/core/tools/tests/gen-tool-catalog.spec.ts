...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'doc_build', 'document_read', 'edit', 'exit_plan_mode',
      'followup_task', 'get_goal', 'glob', 'grep', 'html_build',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'knowledge_search', 'list_agents', 'list_agents', 'lsp', 'mermaid_build', 'pwsh', 'pwsh', 'ralph',
      ...
      'session_event_trace', 'session_search', 'session_trace', 'sheet_analyze', 'sheet_build', 'skill',
      'skill_install', 'slides_build', 'spawn_teammate', 'str_replace_editor', 'subagent', 'svg_build',
      'team_task_create',
